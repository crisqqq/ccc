...
class loginpage:
    ...
    def __init__(self,master):
        ...
        tk.Label(self.page,text='密码：').grid(row=2,column=1,pady=15)
        ...
        tk.Button(self.page,text='登录',command=self.login).grid(row=3,column=1,pady=15)
